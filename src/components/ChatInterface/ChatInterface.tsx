...
export const ChatInterface: React.FC<ChatInterfaceProps> = ({
  ...
  const isB2B = space === 'b2b';
  const headline = isB2B ? "I'm your project advisor" : "I'm your project advisor";
  const subtext = isB2B
    ? 'Material quotes, bulk orders, and project planning'
    : 'How can I help with your project today?';
  const placeholder = isB2B
    ? 'Ask about materials, pricing, or delivery...'
    : 'Ask about a project, product, or how-to...';
  ...
  if (position === 'center' && !hasConversation) {
    return (
      ...
      >
        ...
        >
          <h1 className="text-3xl font-light text-white mb-1">{headline}</h1>
